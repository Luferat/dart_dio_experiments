...
/// ATENÇÃO! Lembre-se de inserir o Dio na chave de dependências no puspec.yaml
///
/// dependencies:
///    dio: ^5.8.0+1
/// Em seguida, executar o cmando pub get para baixar a dependência.
///
...
Future<void> main() async {
  ...
  try {
    ...
    // O endpoint da API recebe todos os "books" com "status=ON" e ordenados por "created_at" (Data de criação).
    ...
    if (response.statusCode == 200) {
      ...
      for (item in allItems) {
        ...
        // Saída do aplicativo para o terminal
        print('''
${item['id']}) ${item['title']}
${item['description']}
 • Autor: ${item['author']}
 • Publicação: ${item['pubyear']}
 • ISBN: ${item['isbn']}
